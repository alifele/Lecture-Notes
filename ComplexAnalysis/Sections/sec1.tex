...
Based on the geometrical interpretation of the complex numbers, it feels natural that we define the argument using the inverse tangent function. $\phi = \arctan(\frac{x}{y})$.
