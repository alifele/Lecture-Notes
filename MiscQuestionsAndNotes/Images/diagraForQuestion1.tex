\begin{figure}[h!]
	...
	\begin{tikzpicture}[x=0.75pt,y=0.75pt,yscale=-1,xscale=1]
		...
		\draw    (180,70) -- (248,70) ;
		\draw [shift={(250,70)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		%Straight Lines [id:da5531596119865458] 
		\draw    (180,150) -- (248,150) ;
		\draw [shift={(250,150)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		...
		\draw    (170,80) -- (254.93,136.3) ;
		\draw [shift={(256.6,137.4)}, rotate = 213.54] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (10.93,-3.29) .. controls (6.95,-1.4) and (3.31,-0.3) .. (0,0) .. controls (3.31,0.3) and (6.95,1.4) .. (10.93,3.29)   ;
		...
		% Text Node
		\draw (209.04,87.52) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize,rotate=-37.3]  {$\pi _{2} \circ i$};
		% Text Node
		...
		% Text Node
		\draw (208,152.4) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize]  {$f$};
		% Text Node
		\draw (210,54.4) node [anchor=north west][inner sep=0.75pt]  [font=\scriptsize]  {$i$};
