\chapter{Topology of Real Numbers}
...
\subsection{Defining addition for the rational numbers}
...
\begin{definition}[Defining summation for the rational numbers]
...
\begin{definition}[Multiplication of the rational numbers]
...
\begin{definition}[Definition of Order]
...
\begin{definition}[Order Relation on $ \mathbb{Z} $]
...
\begin{definition}[Positive rational numbers]
	We say the rational number $ \frac{a}{b} $ is positive if the integer $ ab $ is positive. 
\end{definition}

\begin{definition}[Ordering of rational numbers]
...
\subsection{Constructing the Real Numbers from Rational Numbers}
...
\begin{definition}[The Set of Real Number]
...
\begin{definition}[Addition and Multiplication for Real Numbers]
