...
\begin{example}
	...
	\begin{solution}
		...
		\[ P(0,0) = \prob(X_1 = 0|X_0 =0) = \prob(X_1=0|X_0=0,E_R)\prob(E_R|X_0=0) + \prob(X_1=0|X_0=0,E_B)\prob(E_B|X_0=0), \]
		where $E_R$ is the event at which a red balls is drawn from the Urn, while $E_B$ is the event where a blue ball is drawn.
	\end{solution}
\end{example}
