...
\end{definition}
\begin{remark}
	In different words, a level set of a map is a \emph{regular level set} if for every point on the level set, the differential of the map is \emph{surjective}.
\end{remark}
