...
\begin{problem}[Solution set of two equations (from L. Tu)]
...
\begin{problem}[Regular Submanifolds]
...
\begin{problem}[Graph of a smooth function]
...
\begin{problem}[Euler's Formula (from L. Tu)]
...
\begin{problem}[Product of regular submanifolds (from L. Tu)]
...
\end{solution}
\begin{problem}[Complex Special Linear Group (from L. Tu)]
...
\end{solution}
\begin{problem}[The Transversality Theorem]
	newEnv
\end{problem}
