...
\begin{corollary}[Maps as local coordinate system]
...
Similar to our procedure above, we can find some conditions under which a quotient space of a second countable space is still second countable. This criterion is given in the proposition below.
\begin{proposition}[Second Countability of a Quotient Space ]
...
\begin{summary}[Showing a space is an smooth manifold]
...
\begin{summary}[A confusing thing about the equivalence classes]
	Define $ \sim $ on $ \R $ as
...
\begin{summary}[Strategy to show an equivalence relation is open]
